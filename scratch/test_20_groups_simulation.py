...
async def main():
    ...
    groups = load_groups()
    target_groups = groups[10:30]
    caption = load_caption()
    image_paths = find_media_images()

    print(f"\n=======================================================")
    print(f"🚀 SIMULASI REAL AUTOMATION: GRUP 11 s/d 30")
    print(f"=======================================================\n")
    ...
    async with async_playwright() as pw:
        ...
        for idx, group_url in enumerate(target_groups, 11):
            print(f"\n-------------------------------------------------------")
            print(f"[{idx}/30] Target Grup: {group_url}")
            print(f"-------------------------------------------------------")
    ...
    print(f"\n=======================================================")
    print(f"📊 LAPORAN SIMULASI GRUP 11 s/d 30")
    print(f"=======================================================")
